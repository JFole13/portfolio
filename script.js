...
const generateALiggettDesignsPreviewContent = () => {
  ...
  modalDescriptionContainer.innerHTML = `
    ...
    <p>Listed products can be purchased through Venmo as of right now, while we are working and testing on adding other types 
...
const generateHindsitePreviewContent = () => {
  ...
  modalDescriptionContainer.innerHTML = `
    <p><strong>hindsite</strong> is a trend tracker for all 32 teams in the NHL. After every single matchup, <strong>hindsite</strong>
    ...
    <p>Unfortunately the project is defunct for now, as some as the necessary packages aren't supported anymore. I loved this 
...
const generateBlackJackPreviewContent = () => {
  ...
  modalDescriptionContainer.innerHTML = `
    <p>This is a game of normal <strong>blackjack</strong>, with the options to double down and pay insurance. It's a static site,
        with game logic being handled with vanilla javascript. Animations are made with plain CSS.</p>
    <p>This is my very first project I made by myself when I first started getting into web development and it's still one of my
